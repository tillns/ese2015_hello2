		...
		<!-- Header -->
			<div id="header-wrapper">
				<header id="header" class="container">
					...
					<!-- Logo -->
						<div id="logo">
							<h1><a href="http://localhost:8080/Skeleton/homepage">Verti</a></h1>
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								<li><a href="http://localhost:8080/Skeleton/">Welcome</a></li>
								<li>
									<a href="">Dropdown</a>
									<ul>
								...
								<li><a href="http://localhost:8080/Skeleton/">Create New User</a></li>
								<li><a href="team">Create New Team</a></li>
							</ul>
						</nav>
